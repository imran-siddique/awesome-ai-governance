...
- [Nobulex](https://github.com/arian-gogani/nobulex) - Credit scores for AI agents. Bilateral Ed25519 receipts (pre- and post-execution signatures, hash-chained via JCS/RFC 8785) accumulate into Trust Capital, a 300-850 reputation score that gates agent autonomy. Receipt-signing approach [merged into AGT](https://github.com/microsoft/agent-governance-toolkit/pull/1333). OWASP CheatSheetSeries sections 8-11 [merged](https://github.com/OWASP/CheatSheetSeries/pull/2210). CTEF 14/14 conformance. Python + TypeScript SDKs. MIT licensed.
